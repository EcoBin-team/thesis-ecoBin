            ...
            <View>
                <View style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
                    ...
                    <View style={{top: 50, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
                        ...
                        <TouchableOpacity style={{borderRadius: 38, backgroundColor: "#09E4AF", alignItems: "center", padding: 10, width: 300, marginTop: 20}} onPress={() => navigation.navigate("Conversations")}>
