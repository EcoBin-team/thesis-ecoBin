const { getOneFeed, getAllFeeds,postComment ,getAllComments,postLike,deleteLike,getAllLikesByPostId,updateLikeCount} = require('../controllers/feeds');
...
router.put('feeds/:id/updatelike', updateLikeCount)
